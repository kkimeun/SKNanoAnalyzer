...
output_dir = os.path.join(base_dir, "compare_data_grouped_mc_stack_withW")
...
SINGLETOP_COLOR = ROOT.TColor.GetColor("#c0d6a5")  # grass
Wjets_COLOR = ROOT.TColor.GetColor("#bac4ff") # sky
